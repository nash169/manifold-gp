...
# Get eigenvectors
T, V = torch.lobpcg(L, k=100, largest=False)
...
# gp_r.kernel_.eigenvalues = T.real[0:100]
# gp_r.kernel_.eigenvectors = V[:, 0:100].real
...
# # opt = torch.optim.Adam(gp_a.parameters(), lr=1e-4)
# # for i in range(1000):
# #     K = gp_a.covariance()
