...
def symmetric_laplacian(x, epsilon, neighbors):
    import faiss
...
if __name__ == "__main__":
    ...
    # laplacian matrix
    L_mat = symmetric_laplacian(sampled_x, kernel.epsilon, kernel.neighbors)

    # laplacian operator
    L_opt = kernel.laplacian("symmetric")
    ...
    # eig
    evals_mat, evecs_mat = torch.linalg.eigh(L_mat)
